...
class SentryAppDetailPermission(ScopedPermission):
...
class SentryAppDetailsEndpoint(Endpoint):
    ...
    permission_classes = (SentryAppDetailPermission, )
...
class SentryAppInstallationDetailPermission(ScopedPermission):
...
class SentryAppInstallationDetailEndpoint(Endpoint):
    authentication_classes = (IsAuthenticated, )
    permission_classes = (SentryAppInstallationDetailPermission, )
...
class SentryAppInstallationAuthorizationEndpoint(SentryAppInstallationDetailEndpoint):
